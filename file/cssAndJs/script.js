...
/*add style in js*/
if (phoneOrPc==0) {var h1Size=w*0.024; pageWidth=0.8*w;} else {  var h1Size=w*0.036; pageWidth=0.999*w;}
...
insertStyle[3]=" .normalFont {font-size:"+h1Size*0.7+"px;color:#555555;text-align:left;line-height:"+h1Size*1.2  +"px;}";
